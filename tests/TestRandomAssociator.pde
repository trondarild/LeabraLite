class TestRandomAssociator {
    ...
    LayerConnection input_hidden_conn;
    LayerConnection hidden_output_conn;
    LayerConnection hidden_hidden_conn;
    LayerConnection output_hidden_conn;
    LayerConnection input_inhhidden_conn;
    LayerConnection inhhidden_output_conn;
    ...
    TestRandomAssociator() {
        ...
        ffexcite_spec_learn.lrate = lrate;
        ...
        // connections
        input_hidden_conn = new LayerConnection(input_layer, hidden_layer, ffexcite_spec_learn);
        hidden_output_conn = new LayerConnection(hidden_layer, output_layer, ffexcite_spec_learn);
        hidden_hidden_conn = new LayerConnection(hidden_layer, hidden_layer, inh_spec);
        output_hidden_conn = new LayerConnection(output_layer, hidden_layer, inh_spec);
        input_inhhidden_conn = new LayerConnection(input_layer, inh_hidden_layer, ffexcite_spec_learn);
        inhhidden_output_conn = new LayerConnection(inh_hidden_layer, output_layer, inh_spec);
