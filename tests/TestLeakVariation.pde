class TestLeakVariation {
    ...
    TestLeakVariation () {
        ...
        leak_spec = new UnitSpec(excite_unit_spec);
        ...
        hidden_layer = new Layer(hiddensize, new LayerSpec(false), leak_spec, HIDDEN, "Hidden");
    ...
    void tick() {
        leak_spec.g_l = leakval;
        leak_spec.g_bar_l = maxleakval;
    ...
    void draw() {
        ...
        pushMatrix();
            ...
            drawBarChart(multiply(leakval, ones(1)), "Leakval");
            drawBarChart(multiply(maxleakval, ones(1)), "Max Leakval");
            drawTimeSeriesPlot(input_layer.getBufferVals(), "Input");
            drawTimeSeriesPlot(hidden_layer.getBufferVals(), "Hidden");
            
            drawBarChart(multiply(xmarg, ones(1)), "xmarg");
    ...
    void drawTimeSeriesPlot(float[][] data, String legend){
        ...
        translate(100, -10);
        //float[][] ts = {data};
        drawTimeSeries(data, 0., 1., 1.0, 0., null);
        popMatrix();
        popMatrix();
    }
